...
function loadProblem() {
	...
	if(document.getElementById('inputGroupSelect04').value  == "ft06") {
		document.getElementById('textinput').value = `Fisher and Thompson 6x6 instance, alternate name (mt06)
		6 6
	...
	if(document.getElementById('inputGroupSelect04').value  == "ft10") {
		document.getElementById('textinput').value = ` Fisher and Thompson 10x10 instance, alternate name (mt10)
		10 10
	...
	if(document.getElementById('inputGroupSelect04').value  == "ft20") {
		document.getElementById('textinput').value = `Fisher and Thompson 20x5 instance, alternate name (mt20)
		20 5
	...
	if(document.getElementById('inputGroupSelect04').value  == "la11") {
		document.getElementById('textinput').value = `Lawrence 20x5 instance (Table 5, instance 1); also called (seth1) or H1
		20 5
	...
	if(document.getElementById('inputGroupSelect04').value  == "la12") {
		document.getElementById('textinput').value = `Lawrence 20x5 instance (Table 5, instance 2); also called (seth2) or H2
		20 5
	...
	if(document.getElementById('inputGroupSelect04').value  == "la13") {
		document.getElementById('textinput').value = `Lawrence 20x5 instance (Table 5, instance 3); also called (seth3) or (H3)
		20 5
	...
	if(document.getElementById('inputGroupSelect04').value  == "la14") {
		document.getElementById('textinput').value = `Lawrence 20x5 instance (Table 5, instance 4); also called (seth4) or (H4)
		20 5
	...
	if(document.getElementById('inputGroupSelect04').value  == "la15") {
		document.getElementById('textinput').value = `Lawrence 20x5 instance (Table 5, instance 5); also called (seth5) or (H5)
		20 5
	...
	if(document.getElementById('inputGroupSelect04').value  == "la16") {
		document.getElementById('textinput').value = `Lawrence 10x10 instance (Table 6, instance 1); also called (seta1) or (A1)
		10 10
	...
	if(document.getElementById('inputGroupSelect04').value  == "la17") {
		document.getElementById('textinput').value = `Lawrence 10x10 instance (Table 6, instance 2); also called (seta2) or (A2)
		10 10
	...
	if(document.getElementById('inputGroupSelect04').value  == "la18") {
		document.getElementById('textinput').value = `Lawrence 10x10 instance (Table 6, instance 3); also called (seta3) or (A3)
		10 10
	...
	if(document.getElementById('inputGroupSelect04').value  == "la19") {
		document.getElementById('textinput').value = `Lawrence 10x10 instance (Table 6, instance 4); also called (seta4) or (A4)
		10 10
	...
	if(document.getElementById('inputGroupSelect04').value  == "la20") {
		document.getElementById('textinput').value = `Lawrence 10x10 instance (Table 6, instance 5); also called (seta5) or (A5)
		10 10
	...
	if(document.getElementById('inputGroupSelect04').value  == "la21") {
		document.getElementById('textinput').value = `Lawrence 15x10 instance (Table 7, instance 1); also called (setb1) or (B1)
		15 10
	...
	if(document.getElementById('inputGroupSelect04').value  == "la22") {
		document.getElementById('textinput').value = `Lawrence 15x10 instance (Table 7, instance 2); also called (setb2) or (B2)
		15 10
	...
	if(document.getElementById('inputGroupSelect04').value  == "la23") {
		document.getElementById('textinput').value = `Lawrence 15x10 instance (Table 7, instance 3); also called (setb3) or (B3)
		15 10
	...
	if(document.getElementById('inputGroupSelect04').value  == "la24") {
		document.getElementById('textinput').value = `Lawrence 15x10 instance (Table 7, instance 4); also called (setb4) or (B4)
		15 10
	...
	if(document.getElementById('inputGroupSelect04').value  == "la25") {
		document.getElementById('textinput').value = `Lawrence 15x10 instance (Table 7, instance 5); also called (setb5) or (B5)
		15 10
	...
	if(document.getElementById('inputGroupSelect04').value  == "la26") {
		document.getElementById('textinput').value = `Lawrence 20x10 instance (Table 8, instance 1); also called (setc1) or (C1)
		20 10
	...
	if(document.getElementById('inputGroupSelect04').value  == "la27") {
		document.getElementById('textinput').value = `Lawrence 20x10 instance (Table 8, instance 2); also called (setc2) or (C2)
		20 10
	...
	if(document.getElementById('inputGroupSelect04').value  == "la28") {
		document.getElementById('textinput').value = `Lawrence 20x10 instance (Table 8, instance 3); also called (setc3) or (C3)
		20 10
	...
	if(document.getElementById('inputGroupSelect04').value  == "la29") {
		document.getElementById('textinput').value = `Lawrence 20x10 instance (Table 8, instance 4); also called (setc4) or (C4)
		20 10
	...
	if(document.getElementById('inputGroupSelect04').value  == "la30") {
		document.getElementById('textinput').value = `Lawrence 20x10 instance (Table 8, instance 5); also called (setc5) or (C5)
		20 10
	...
	if(document.getElementById('inputGroupSelect04').value  == "la31") {
		document.getElementById('textinput').value = ` Lawrence 30x10 instance (Table 9, instance 1); also called (setd1) or (D1)
		30 10
	...
	if(document.getElementById('inputGroupSelect04').value  == "la32") {
		document.getElementById('textinput').value = ` Lawrence 30x10 instance (Table 9, instance 2); also called (setd2) or (D2)
		30 10
	...
	if(document.getElementById('inputGroupSelect04').value  == "la33") {
		document.getElementById('textinput').value = ` Lawrence 30x10 instance (Table 9, instance 3); also called (setd3) or (D3)
		30 10
	...
	if(document.getElementById('inputGroupSelect04').value  == "la34") {
		document.getElementById('textinput').value = ` Lawrence 30x10 instance (Table 9, instance 4); also called (setd4) or (D4)
		30 10
	...
	if(document.getElementById('inputGroupSelect04').value  == "la35") {
		document.getElementById('textinput').value = ` Lawrence 30x10 instance (Table 9, instance 5); also called (setd5) or (D5)
		30 10
	...
	if(document.getElementById('inputGroupSelect04').value  == "la36") {
		document.getElementById('textinput').value = ` Lawrence 15x15 instance (Table 10, instance 1); also called (seti1) or (I1)
		15 15
	...
	if(document.getElementById('inputGroupSelect04').value  == "la37") {
		document.getElementById('textinput').value = ` Lawrence 15x15 instance (Table 10, instance 2); also called (seti2) or (I2)
		15 15
	...
	if(document.getElementById('inputGroupSelect04').value  == "la38") {
		document.getElementById('textinput').value = ` Lawrence 15x15 instance (Table 10, instance 3); also called (seti3) or (I3)
		15 15
	...
	if(document.getElementById('inputGroupSelect04').value  == "la39") {
		document.getElementById('textinput').value = ` Lawrence 15x15 instance (Table 10, instance 4); also called (seti4) or (I4)
		15 15
	...
	if(document.getElementById('inputGroupSelect04').value  == "la40") {
		document.getElementById('textinput').value = ` Lawrence 15x15 instance (Table 10, instance 5); also called (seti5) or (I5)
		15 15
	...
	if(document.getElementById('inputGroupSelect04').value  == "orb02") {
	...
	if(document.getElementById('inputGroupSelect04').value  == "orb03") {
		document.getElementById('textinput').value = ` deadlier 10x10 instance from Bruce Gamble (BRG1)
		10 10
	...
	if(document.getElementById('inputGroupSelect04').value  == "orb04") {
		document.getElementById('textinput').value = ` deadly 10x10 instance from Bruce Shepherd (BRS1)
		10 10
	...
	if(document.getElementById('inputGroupSelect04').value  == "orb05") {
		document.getElementById('textinput').value = ` 10x10 instance from George Steiner (GES1)
		10 10
	...
	if(document.getElementById('inputGroupSelect04').value  == "orb06") {
		document.getElementById('textinput').value = ` trivial 10X10 instance from Bill Cook (BIC1)
		10 10
	...
	if(document.getElementById('inputGroupSelect04').value  == "orb07") {
		document.getElementById('textinput').value = ` doomed 10x10 instance from Monika (MON1)
		10 10
	...
	if(document.getElementById('inputGroupSelect04').value  == "orb08") {
		document.getElementById('textinput').value = ` deadlier 10x10 instance from Bruce Gamble (BRG2)
		10 10
	...
	if(document.getElementById('inputGroupSelect04').value  == "orb09") {
		document.getElementById('textinput').value = ` deadly 10x10 instance from Bruce Shepherd (BRS2)
		10 10
	...
	if(document.getElementById('inputGroupSelect04').value  == "orb10") {
		document.getElementById('textinput').value = ` 10x10 instance from George Steiner (GES2)
		10 10
	...
	if(document.getElementById('inputGroupSelect04').value  == "swv03") {
		document.getElementById('textinput').value = ` Storer, Wu, and Vaccari hard 20x10 instance (Table 2, instance 3)
		20 10
	...
	if(document.getElementById('inputGroupSelect04').value  == "swv04") {
		document.getElementById('textinput').value = ` Storer, Wu, and Vaccari hard 20x10 instance (Table 2, instance 4)
		20 10
	...
	if(document.getElementById('inputGroupSelect04').value  == "swv05") {
		document.getElementById('textinput').value = ` Storer, Wu, and Vaccari hard 20x10 instance (Table 2, instance 5)
		20 10
	...
	if(document.getElementById('inputGroupSelect04').value  == "swv06") {
		document.getElementById('textinput').value = ` Storer, Wu, and Vaccari hard 20x15 instance (Table 2, instance 6)
		20 15
	...
	if(document.getElementById('inputGroupSelect04').value  == "swv07") {
		document.getElementById('textinput').value = ` Storer, Wu, and Vaccari hard 20x15 instance (Table 2, instance 7)
		20 15
	...
	if(document.getElementById('inputGroupSelect04').value  == "swv08") {
		document.getElementById('textinput').value = ` Storer, Wu, and Vaccari hard 20x15 instance (Table 2, instance 8)
		20 15
	...
	if(document.getElementById('inputGroupSelect04').value  == "swv09") {
		document.getElementById('textinput').value = ` Storer, Wu, and Vaccari hard 20x15 instance (Table 2, instance 9)
		20 15
	...
	if(document.getElementById('inputGroupSelect04').value  == "swv10") {
		document.getElementById('textinput').value = ` Storer, Wu, and Vaccari hard 20x15 instance (Table 2, instance 10)
		20 15
	...
	if(document.getElementById('inputGroupSelect04').value  == "swv11") {
		document.getElementById('textinput').value = ` Storer, Wu, and Vaccari hard 50x10 instance (Table 2, instance 11)
		50 10
	...
	if(document.getElementById('inputGroupSelect04').value  == "swv12") {
		document.getElementById('textinput').value = ` Storer, Wu, and Vaccari hard 50x10 instance (Table 2, instance 12)
		50 10
	...
	if(document.getElementById('inputGroupSelect04').value  == "swv13") {
		document.getElementById('textinput').value = ` Storer, Wu, and Vaccari hard 50x10 instance (Table 2, instance 13)
		50 10
	...
	if(document.getElementById('inputGroupSelect04').value  == "swv14") {
		document.getElementById('textinput').value = ` Storer, Wu, and Vaccari hard 50x10 instance (Table 2, instance 14)
		50 10
	...
	if(document.getElementById('inputGroupSelect04').value  == "swv15") {
		document.getElementById('textinput').value = ` Storer, Wu, and Vaccari hard 50x10 instance (Table 2, instance 15)
		50 10
	...
	if(document.getElementById('inputGroupSelect04').value  == "swv16") {
		document.getElementById('textinput').value = ` Storer, Wu, and Vaccari easy 50x10 instance (Table 2, instance 16)
		50 10
	...
	if(document.getElementById('inputGroupSelect04').value  == "swv17") {
		document.getElementById('textinput').value = ` Storer, Wu, and Vaccari easy 50x10 instance (Table 2, instance 17)
		50 10
	...
	if(document.getElementById('inputGroupSelect04').value  == "swv18") {
		document.getElementById('textinput').value = ` Storer, Wu, and Vaccari easy 50x10 instance (Table 2, instance 18)
		50 10
	...
	if(document.getElementById('inputGroupSelect04').value  == "swv19") {
		document.getElementById('textinput').value = ` Storer, Wu, and Vaccari easy 50x10 instance (Table 2, instance 19)
		50 10
	...
	if(document.getElementById('inputGroupSelect04').value  == "swv20") {
		document.getElementById('textinput').value = ` Storer, Wu, and Vaccari easy 50x10 instance (Table 2, instance 20)
		50 10
	...
	if(document.getElementById('inputGroupSelect04').value  == "yn1") {
	...
	if(document.getElementById('inputGroupSelect04').value  == "yn2") {
	...
	if(document.getElementById('inputGroupSelect04').value  == "yn3") {
		document.getElementById('textinput').value = ` Yamada and Nakano 20x20 instance (Table 4, instance 3)
		20 20
	...
	if(document.getElementById('inputGroupSelect04').value  == "yn4") {
		document.getElementById('textinput').value = ` Yamada and Nakano 20x20 instance (Table 4, instance 4)
		20 20
